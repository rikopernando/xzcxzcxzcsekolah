...
$nama_pelanggan = $_GET['nama_pelanggan'];
    ...
    $perintah = $db->query("SELECT tanggal FROM penjualan WHERE no_faktur = '$no_faktur'");
 ...
 <!-- membuat form menjadi beberpa bagian -->
  ...
  <h3> Bayar Penjualan </h3><br>
   ...
   <div class="form-group  col-sm-4">
    ...
    <input type="text" name="no_faktur" id="no_faktur" class="form-control" value="<?php echo $no_faktur; ?>" readonly="" >
    </div>
...
<?php
          ...
          <input type="text" name="tanggal_jt" id="tanggal_jt"  value="" class="form-control tanggal" >
...
if ($_SESSION['otoritas'] == 'Pimpinan') {
 ...
 ?>
          ...
          <a href='cetak_penjualan_tunai_bayar_pesanan.php?no_faktur=<?php echo $no_faktur; ?>' id="cetak_tunai" style="display: none;" class="btn btn-success" target="blank"><span class="glyphicon glyphicon-print"> </span> Cetak Tunai </a>

          <a href='cetak_penjualan_tunai_besar_bayar_pesanan.php?no_faktur=<?php echo $no_faktur; ?>' id="cetak_tunai_besar" style="display: none;" class="btn btn-primary" target="blank"><span class="glyphicon glyphicon-print"> </span> Cetak Tunai Besar </a>

          <a href='cetak_penjualan_piutang_bayar_pesanan.php?no_faktur=<?php echo $no_faktur; ?>' id="cetak_piutang" style="display: none;" class="btn btn-success" target="blank"> <span class="  glyphicon glyphicon-print"> </span> Cetak Piutang </a>
          </div>
  ...
  alert("Jumlah Barang Melebihi Stok");
    ...
    $.post("proses_tambah_pesanan_barang.php",{no_faktur:no_faktur,kode_barang:kode_barang,nama_barang:nama_barang,jumlah_barang:jumlah_barang,harga:harga,harga_baru:harga_baru,potongan:potongan,tax:tax,satuan:satuan,sales:sales,ber_stok:ber_stok},function(data){
     ...
     $("#pembayaran_penjualan").val('');
        ...
        var no_faktur_id = $("#no_faktur").val();
                            ...
                            <script type="text/javascript">
                                 ...
                                 $(".input_jumlah").blur(function(){
                                    ...
                                    $.post("cek_stok_pesanan_barang.php",{kode_barang:kode_barang, jumlah_baru:jumlah_baru},function(data){
                                     ...
                                     $.post("update_pesanan_barang.php",{jumlah_lama:jumlah_lama,jumlah_tax:jumlah_tax,id:id,jumlah_baru:jumlah_baru,kode_barang:kode_barang, potongan:potongan,harga:harga},function(info){
