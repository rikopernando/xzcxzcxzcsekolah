...
<div class="container">
 ...
 <table>
  <tbody>
      ...
      <tr><td  width="25%"><font class="satu"><?php echo $data20['kata_ubah']; ?></font></td> <td> :&nbsp;</td> <td><font class="satu"> <?php echo $data_inner['sales']; ?></font></td></tr>
...
<table id="tableuser" class="table1">
        ...
        $no_urut = 0;
            ...
            <td class='table1'>". $data_inner['satuan'] ."</td>
