...
$nomor_faktur = $_SESSION['no_faktur'];

    $query0 = $db->query("SELECT * FROM pembelian WHERE no_faktur = '$nomor_faktur' ");
    ...
    $query04 = $db->query("SELECT SUM(kredit) as total_kredit FROM pembelian WHERE no_faktur = '$nomor_faktur'");
    $data04 = mysqli_fetch_array($query04);
    $total_kredit = $data04['total_kredit'];

    $query01 = $db->query("SELECT SUM(sisa) as total_kembalian FROM pembelian WHERE no_faktur = '$nomor_faktur'");
    $data01 = mysqli_fetch_array($query01);
    $total_kembalian = $data01['total_kembalian'];

    $query03 = $db->query("SELECT SUM(subtotal) as total_subtotal FROM detail_pembelian WHERE no_faktur = '$nomor_faktur'");
...
<div class="container">
    ...
    <div class="row"><!--row1-->
        ...
        <div class="col-sm-4">
                 <h3> <b> BUKTI PEMBELIAN TUNAI </b></h3>
                 <hr>
...
<table>
  <tbody>
      ...
      <tr><td  width="50%">Suplier</td> <td> : </td> <td> <?php echo $data0['suplier']; ?></td></tr>
