...
$query01 = $db->query("SELECT SUM(potongan) AS total_potongan FROM retur_penjualan WHERE tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal'");
...
$query02 = $db->query("SELECT SUM(total) AS total_akhir FROM retur_penjualan WHERE tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal'");
