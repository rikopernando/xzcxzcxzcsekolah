...
<table>
 ...
 <table id="tableuser" class="table table-hover">
            ...
            <?php
                  ...
                  {
                        ///menampilkan seluruh data yang ada pada tabel penjualan
                        $perintah123 = $db->query("SELECT * FROM retur_penjualan WHERE no_faktur_retur = '$data11[no_faktur_retur]'");
                        ...
                        $perintah012 = $db->query("SELECT * FROM detail_retur_penjualan WHERE no_faktur_retur = '$data11[no_faktur_retur]'");
                        ...
                        <td>". $data123['kode_pelanggan'] ."<br><br><i><u>Jumlah</u>&nbsp;&nbsp;<u>Satuan</u></i><br>". $data012['jumlah_retur'] ." &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ". $cek100['satuan'] ."<br>.........................<br>". $total_barang ."<br><br><b>Pajak : ". rp($data012['tax']) ." </b></td>
