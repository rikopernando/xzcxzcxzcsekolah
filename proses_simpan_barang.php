...
$stmt = $db->prepare("INSERT INTO penjualan (no_faktur, kode_gudang, kode_pelanggan, tanggal, jam, user, sales, status, potongan, no_pesanan) VALUES (?,?,?,?,?,?,?,'Simpan Sementara',?,'1')");
              
    // hubungkan "data" dengan prepared statements
              $stmt->bind_param("sssssssi",
              $no_faktur, $kode_gudang, $kode_pelanggan, $tanggal_sekarang, $jam_sekarang, $user, $sales, $potongan);
